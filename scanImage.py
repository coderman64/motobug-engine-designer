...
# def partScan2(imgName,strings):
#     img1 = Image.open(imgName).convert("RGBA")
#     #initalize array
#     tileData = [[None,None,None,None,None,None,None,None],[None,None,None,None,None,None,None,None],[None,None,None,None,None,None,None,None],[None,None,None,None,None,None,None,None],[None,None,None,None,None,None,None,None],[None,None,None,None,None,None,None,None],[None,None,None,None,None,None,None,None],[None,None,None,None,None,None,None,None]]
#     if "n" in strings:
#         for xtile in range(0,8):
#             for ytile in range(0,8):
#                 for x in range(16):
#                     y = 0
#                     while y < 16:
#                         if img1.getpixel((xtile*16+x,ytile*16+y))[3] != 0:
#                             if tileData[ytile]][xtile] == None:
#                                 tileData[ytile][xtile] = [-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,0]
#                             tileData[ytile][xtile][x%16] = 16-(y%16)
#                             y = 16
#                         y += 1
#         lAngle = None
#         for x in range(0,8):
...
#                     while x < 16:
#                         if img1.getpixel((xtile*16+x,ytile*16+y))[3] != 0:
#                             if tileData[xtile]][ytile] == None:
#                                 tileData[xtile][ytile] = [-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,-16,0]
#                             tileData[ytile][xtile][y%16] = 16-(x%16)
#                             x = 16
#                         x += 1
#         lAngle = -90
#         for y in range(0,8):
